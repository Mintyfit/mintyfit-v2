...
CREATE TABLE IF NOT EXISTS day_meal_config (
...
DROP POLICY IF EXISTS "Family members can read meal configs" ON day_meal_config;
...
DROP POLICY IF EXISTS "Family members can insert meal configs" ON day_meal_config;
...
DROP POLICY IF EXISTS "Family members can update meal configs" ON day_meal_config;
