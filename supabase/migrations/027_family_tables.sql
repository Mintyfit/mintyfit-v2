...
-- Note: nutritionist_client_links and nutritionist_notes already exist

-- ─── All tables created first (policies reference each other) ───────────────
...
CREATE POLICY "Family admin can manage family"
...
CREATE POLICY "Admins manage family memberships"
...
CREATE POLICY "Admins manage managed members"
...
DROP POLICY IF EXISTS "Nutritionist reads client weight logs" ON public.weight_logs;
CREATE POLICY "Nutritionist reads client weight logs"
