// USDA FoodData Central API key. Free tier, browser-exposed by design (this
// module runs client-side). 'DEMO_KEY' is USDA's public rate-limited fallback.
...
export async function lookupNutrition(steps, servings) {
  const { batchLookupIngredients } = await import('@/lib/recipe/ingredientDatabase');
