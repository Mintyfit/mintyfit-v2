...
export function confirmationEmail({ confirmUrl }) {
  return shell({
    ...
    intro: `Thanks for signing up for MintyFit! Click the button below to confirm your email address and activate your account.`,
    ctaUrl: confirmUrl,
    ctaLabel: 'Confirm email',
    secondary: `If you didn't create a MintyFit account, you can safely ignore this email.`,
  })
}
