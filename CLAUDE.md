...
> Claude Code reads this file automatically at session start. These rules apply to ALL tasks.
...
1. Recipe nutrition estimated by Claude Haiku / USDA at creation → stored on recipe
...
6. If any finding is critical, update the relevant knowledge file or CLAUDE.md directly
...
- Session files are the raw input. Pattern/convention files are the refined output. CLAUDE.md is the executive summary.
- Don't bloat CLAUDE.md — only promote findings confirmed in 2+ sessions or that prevent major bugs
